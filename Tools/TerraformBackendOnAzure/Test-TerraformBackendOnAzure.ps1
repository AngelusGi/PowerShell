...
Measure-CustomerPrefix -ResourcePrefix $ResourcePrefix

Set-PsEvnironment -PsModulesToInstall "Az" -OnlyAbovePs6 $true -ModulesToInstall "ModuleManager", "TerraformBackendOnAzure"

# exectues custom modules
Get-EnvironmentInstaller -Modules $PsModulesToInstall -OnlyAbovePs6 $OnlyAbovePs6 -Scope $Scope
